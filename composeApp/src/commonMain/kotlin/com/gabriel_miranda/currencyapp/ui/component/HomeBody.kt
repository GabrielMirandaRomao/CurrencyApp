...
import com.gabriel_miranda.currencyapp.util.DoubleConverter
import com.gabriel_miranda.currencyapp.util.calculateExchangeRate
import com.gabriel_miranda.currencyapp.util.convert
    ...
    Column(
        ...
        Button(
            modifier = Modifier
                .fillMaxWidth()
                .height(70.dp)
                .padding(end = 24.dp, start = 24.dp, bottom = 14.dp)
                .background(
